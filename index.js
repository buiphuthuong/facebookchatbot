...
const callSendAPI = async (sender_psid, response) => {
  ...
  await request(
    {
      uri: 'https://graph.facebook.com/v12.0/me/messages?access_token=EAAMj6ZA9o2XkBAEdaCeI4AEoGVZAijRpvgr7u9QkegJBZAGkZB0r17hNz10aZCP7aHvZCmYNsPaxk27H1BrWcJaZBZAXupBp3CGP68ieDDfM1StpAN4kHbT1ZAPytEgtomDgmWesUyRLZBC74MvYw60YZC9zS52wAuxa72uZAx7uj5S65ZAqyVraZCCoZAvf03YrGi3TykZD',
      qs: {
        access_token:
    ...
    (err, res, body) => {
      if (!err) {
        console.log('message sent 3!', res)
      } else {
